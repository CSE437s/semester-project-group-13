CREATE TABLE `volunteers` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `volunteers_ibfk_1` FOREIGN KEY (`family_id`) REFERENCES `families` (`family_id`),
...
CREATE TABLE `refugees` (
  ...
  CONSTRAINT `refugees_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
...
CREATE TABLE `families` (
  ...
  `is_refugee` tinyint(1) DEFAULT 0,
  `is_good_neighbor` tinyint(1) DEFAULT 0,
  `user_id` int DEFAULT NULL,
